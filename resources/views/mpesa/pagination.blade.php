<div class="table-responsive">
    <table  class="table table-hover manage-u-table">
        ...
        @foreach($results AS $value)
            @if($value->department->department_name == 'Administration' && $signed_in_user_role !=='10')
                ..
            @else
                <tr class="{!! $value->employee_id !!}">
                    ...
                    <td>
                    <span class="font-medium">
                         @if (isset($value->jobCategory->name)) {!! $value->jobCategory->name!!} <span class="bdColor"></span> @endif
                     </span>
                    </td>
                    <td>
                    <span class="font-medium">
