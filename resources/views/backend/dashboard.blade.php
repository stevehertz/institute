                    ...
                    <div class="row">
                        ...
                        @if (auth()->user()->hasRole('student'))
                            ...
                            @if (count($pending_orders) > 0)
                                ...
                                <div class="col-12">
                                    <p class="btn btn-primary" onClick="refreshPage()">If already paid for orders below, click
                                        here to refresh </p>
                                </div>
                            ...
                            @else
                                <div class="col-12 text-center">
                                    ...
                                    <a class="btn btn-primary" href="{{ route('courses.all') }}">@lang('labels.backend.dashboard.buy_course_now')
                        ...
                        @elseif(auth()->user()->hasRole('administrator'))
                            ...
                            <div class="col-md-6 col-12 border-right">
                                <div class="d-inline-block form-group w-100">
                                    <h4 class="mb-0">@lang('labels.backend.dashboard.recent_orders') <a class="btn btn-primary float-right"
                            ...
                            <div class="col-md-6 col-12">
                                <div class="d-inline-block form-group w-100">
                                    <h4 class="mb-0">@lang('labels.backend.dashboard.recent_contact_requests') <a class="btn btn-primary float-right"
