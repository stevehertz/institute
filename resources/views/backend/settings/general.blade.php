...
{{--                            Pesapal settings here--}}
                            <div class="form-group row">
                                {{ html()->label(__('labels.backend.general_settings.payment_settings.pesapal'))->class('col-md-3 form-control-label')}}
                                <div class="col-md-9">
                                    <div class="checkbox">
                                        {{ html()->label(
                                                html()->checkbox('pesapal__active', config('pesapal.active') ? true : false,1)
                                                      ->class('switch-input')->value(1)
                                                . '<span class="switch-label"></span><span class="switch-handle"></span>')

                                            ->class('switch switch-sm switch-3d switch-primary')
                                        }}
                                        <a target="_blank" href="https://developer.pesapal.com/developer/applications/"
                                           class="float-right font-italic font-weight-bold">{{ __('labels.backend.general_settings.payment_settings.how_to_pesapal')}}</a>
                                    </div>
                                    <small>
                                        <i> {{ __('labels.backend.general_settings.payment_settings.pesapal_note')}}</i>
                                    </small>
{{--                                    <div class="switch-content @if(config('pesapal.active') == 0 || config('pesapal.active') == false) d-none @endif">--}}
{{--                                        <br>--}}
{{--                                        <div class="form-group row">--}}
{{--                                            {{ html()->label(__('labels.backend.general_settings.payment_settings.mode'))->class('col-md-2 form-control-label') }}--}}
{{--                                            <div class="col-md-8 col-xs-12">--}}
{{--                                                <select class="form-control" id="pesapal_settings_mode"--}}
{{--                                                        name="pesapal__settings__mode">--}}
{{--                                                    <option selected--}}
{{--                                                            value="sandbox">{{__('labels.backend.general_settings.payment_settings.sandbox')}}</option>--}}
{{--                                                    <option value="live">{{__('labels.backend.general_settings.payment_settings.live')}}</option>--}}
{{--                                                </select>--}}
...
{{--                                            {{ html()->label(__('labels.backend.general_settings.payment_settings.client_id'))->class('col-md-2 form-control-label') }}--}}
{{--                                            <div class="col-md-8 col-xs-12">--}}
{{--                                                {{ html()->text('pesapal__client_id')--}}
{{--                                                     ->class('form-control')--}}
{{--                                                     ->value(config('pesapal.client_id'))--}}
{{--                                                     }}--}}
{{--                                            </div><!--col-->--}}
{{--                                        </div><!--form-group-->--}}
{{--                                        <div class="form-group row">--}}
{{--                                            {{ html()->label(__('labels.backend.general_settings.payment_settings.client_secret'))->class('col-md-2 form-control-label')->for('pesapal.pesapal.secret') }}--}}
{{--                                            <div class="col-md-8 col-xs-12">--}}
{{--                                                {{ html()->text('pesapal__secret')--}}
{{--                                                     ->class('form-control')--}}
{{--                                                     ->value(config('pesapal.secret'))--}}
{{--                                                     }}--}}
{{--                                            </div><!--col-->--}}
{{--                                        </div><!--form-group-->--}}
{{--                                    </div>--}}
                            ...
                            {{--                            Mpesa settings here--}}
                            <div class="form-group row">
                                {{ html()->label(__('labels.backend.general_settings.payment_settings.mpesa'))->class('col-md-3 form-control-label')}}
                                <div class="col-md-9">
                                    <div class="checkbox">
                                        {{ html()->label(
                                                html()->checkbox('mpesa__active', config('mpesa.active') ? true : false,1)
                                                      ->class('switch-input')->value(1)
                                                . '<span class="switch-label"></span><span class="switch-handle"></span>')
                                        ...
                                        <a target="_blank" href="https://developer.safaricom.co.ke/"
                                           class="float-right font-italic font-weight-bold">{{ __('labels.backend.general_settings.payment_settings.how_to_mpesa')}}</a>
                                    </div>
                                    <small>
                                        <i> {{ __('labels.backend.general_settings.payment_settings.mpesa_note')}}</i>
                                    </small>
{{--                                    <div class="switch-content @if(config('mpesa.active') == 0 || config('mpesa.active') == false) d-none @endif">--}}
{{--                                        <br>--}}
{{--                                        <div class="form-group row">--}}
{{--                                            {{ html()->label(__('labels.backend.general_settings.payment_settings.mode'))->class('col-md-2 form-control-label') }}--}}
{{--                                            <div class="col-md-8 col-xs-12">--}}
{{--                                                <select class="form-control" id="mpesa_settings_mode"--}}
{{--                                                        name="mpesa__settings__mode">--}}
{{--                                                    <option selected--}}
{{--                                                            value="sandbox">{{__('labels.backend.general_settings.payment_settings.sandbox')}}</option>--}}
{{--                                                    <option value="live">{{__('labels.backend.general_settings.payment_settings.live')}}</option>--}}
{{--                                                </select>--}}
...
{{--                                        <div class="form-group row">--}}
{{--                                            {{ html()->label(__('labels.backend.general_settings.payment_settings.mpesa_paybill'))->class('col-md-2 form-control-label') }}--}}
{{--                                            <div class="col-md-8 col-xs-12">--}}
{{--                                                {{ html()->text('mpesa__paybill')--}}
{{--                                                     ->class('form-control')--}}
{{--                                                     ->value(config('mpesa.paybill'))--}}
{{--                                                     }}--}}
{{--                                            </div><!--col-->--}}
{{--                                        </div>--}}
{{--                                        <div class="form-group row">--}}
{{--                                            {{ html()->label(__('labels.backend.general_settings.payment_settings.mpesa_consumer_key'))->class('col-md-2 form-control-label') }}--}}
{{--                                            <div class="col-md-8 col-xs-12">--}}
{{--                                                {{ html()->text('mpesa__consumer_key')--}}
{{--                                                     ->class('form-control')--}}
{{--                                                     ->value(config('mpesa.consumer_key'))--}}
{{--                                                     }}--}}
{{--                                            </div><!--col-->--}}
{{--                                        </div><!--form-group-->--}}
{{--                                        <div class="form-group row">--}}
{{--                                            {{ html()->label(__('labels.backend.general_settings.payment_settings.client_secret'))->class('col-md-2 form-control-label')->for('mpesa.mpesa.secret') }}--}}
{{--                                            <div class="col-md-8 col-xs-12">--}}
{{--                                                {{ html()->text('mpesa__secret')--}}
{{--                                                     ->class('form-control')--}}
{{--                                                     ->value(config('mpesa.secret'))--}}
{{--                                                     }}--}}
{{--                                            </div><!--col-->--}}
{{--                                        </div>--}}
{{--                                        <div class="form-group row">--}}
{{--                                            {{ html()->label(__('labels.backend.general_settings.payment_settings.initiator_username'))->class('col-md-2 form-control-label')->for('mpesa.mpesa.secret') }}--}}
{{--                                            <div class="col-md-8 col-xs-12">--}}
{{--                                                {{ html()->text('mpesa__initiator_username')--}}
{{--                                                     ->class('form-control')--}}
{{--                                                     ->value(config('mpesa.initiator_username'))--}}
{{--                                                     }}--}}
{{--                                            </div><!--col-->--}}
{{--                                        </div>--}}
{{--                                        <div class="form-group row">--}}
{{--                                            {{ html()->label(__('labels.backend.general_settings.payment_settings.lipa_na_mpesa_passkey'))->class('col-md-2 form-control-label')->for('mpesa.mpesa.secret') }}--}}
{{--                                            <div class="col-md-8 col-xs-12">--}}
{{--                                                {{ html()->text('mpesa__lipa_na_mpesa_passkey')--}}
{{--                                                     ->class('form-control')--}}
{{--                                                     ->value(config('mpesa.lipa_na_mpesa_passkey'))--}}
{{--                                                     }}--}}
{{--                                            </div><!--col-->--}}
{{--                                        </div>--}}
