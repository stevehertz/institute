...
@section('content')
    {!! Form::open(['method' => 'POST', 'route' => ['admin.exam_questions.store'], 'files' => true,]) !!}
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-12 form-group">
                    ...
                    {!! Form::select('exams[]', $exams, old('exams'), ['class' => 'form-control select2', 'multiple' => 'multiple', 'required' => false]) !!}
                    <p class="help-block"></p>
                    @if($errors->has('exams'))
                        <p class="help-block">
                            {{ $errors->first('exams') }}
