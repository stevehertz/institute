...
@section('content')
    ...
    {!! Form::model($question, ['method' => 'PUT', 'route' => ['admin.exam_questions.update', $question->id], 'files' => true,]) !!}

    <div class="card">
        <div class="card-header">
            <h3 class="page-title float-left mb-0">@lang('labels.backend.questions.edit')</h3>
            <div class="float-right">
                <a href="{{ route('admin.exam_questions.index') }}"
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-12 form-group">
                    {!! Form::label('exams', trans('labels.backend.questions.fields.exams'), ['class' => 'control-label']) !!}
                    {!! Form::select('exams[]', $exams, old('exams') ? old('exams') : $question->exams->pluck('id')->toArray(), ['class' => 'form-control select2', 'multiple' => 'multiple', 'required' => true]) !!}
                    <p class="help-block"></p>
                    @if($errors->has('exams'))
                        <p class="help-block">
                            {{ $errors->first('exams') }}
