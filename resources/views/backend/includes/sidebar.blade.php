...
<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            @can('order_access')
                <li class="nav-item ">
                    <a class="nav-link {{ $request->segment(1) == 'orders' ? 'active' : '' }}"
                        ...
                        <span class="title">
                            @lang('menus.backend.sidebar.orders.title')</span>
                    </a>
                </li>
            @endcan
            ...
            @can('order_access')
                <li class="nav-item ">
                    <a class="nav-link {{ $request->segment(1) == 'enrolments' ? 'active' : '' }}"
                        href="{{ route('admin.course.enrolments') }}">
                        <i class="nav-icon icon-bag"></i>
                        <span class="title">@lang('menus.backend.sidebar.enrolments')</span>
                    </a>
                </li>
            @endcan
            ...
            @can('category_access')
                <li class="nav-item ">
                    <a class="nav-link {{ $request->segment(2) == 'categories' ? 'active' : '' }}"
                        ...
                        <span class="title">
                            @lang('menus.backend.sidebar.categories.title')
                        </span>
                    </a>
                </li>
            @endcan
            ...
            @if (
                !$logged_in_user->hasRole('student') &&
                    ($logged_in_user->hasRole('instructor') ||
                ...
                @if ($logged_in_user->hasRole('instructor') || $logged_in_user->isAdmin())
                    <li
                        class="nav-item nav-dropdown {{ active_class(Active::checkUriPattern(['user/exams*', 'user/exam-questions*']), 'open') }}">
                        <a class="nav-link nav-dropdown-toggle {{ active_class(Active::checkUriPattern('admin/*')) }}"
                            href="#">
                            <i class="nav-icon icon-puzzle"></i> @lang('menus.backend.sidebar.exams.management')
                        ...
                        <ul class="nav-dropdown-items">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link {{ $request->segment(2) == 'exams' ? 'active' : '' }}"
                                    href="{{ route('admin.exams.index') }}">
                                    <span class="title">@lang('menus.backend.sidebar.exams.title')</span>
                                </a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link {{ $request->segment(2) == 'questions' ? 'active' : '' }}"
                                    href="{{ route('admin.exam_questions.index') }}">
                                    <span class="title">@lang('menus.backend.sidebar.questions.title')</span>
                                </a>
                            </li>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link {{ $request->segment(2) == 'live-lesson-slots' ? 'active' : '' }}"
                                    href="{{ route('admin.live-lesson-slots.index') }}">
                                    <span class="title">@lang('menus.backend.sidebar.exams.exam_calendar')</span>
                                </a>
                            </li>
                ...
                <li
                    ...
                    <ul class="nav-dropdown-items">
                        ...
                        @if ($logged_in_user->isAdmin())
                            ...
                            <li class="nav-item ">
                                <a class="nav-link {{ $request->segment(2) == 'partners' ? 'active' : '' }}"
                                    href="{{ route('admin.partners.index') }}">
                                    <span class="title">@lang('menus.backend.sidebar.partners.title')</span>
                                </a>
                            </li>
                            <li class="nav-item ">
            ...
            <li class="nav-item ">
                <a class="nav-link {{ $request->segment(1) == 'messages' ? 'active' : '' }}"
                    ...
                    <i class="nav-icon icon-envelope-open"></i> <span class="title">@lang('menus.backend.sidebar.messages.title')</span>
                </a>
            </li>
            ...
            @if ($logged_in_user->hasRole('student'))
                <li class="nav-item ">
                    <a class="nav-link {{ $request->segment(1) == 'invoices' ? 'active' : '' }}"
                        ...
                        <i class="nav-icon icon-notebook"></i> <span class="title">@lang('menus.backend.sidebar.invoices.title')</span>
                    </a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link {{ $request->segment(1) == 'exams' ? 'active' : '' }}"
                        href="{{ route('admin.studentExams') }}">
                        <i class="nav-icon icon-notebook"></i> <span class="title">@lang('menus.backend.sidebar.exams.title')</span>
                    </a>
                </li>
                <li class="nav-item ">
                    <a class="nav-link {{ $request->segment(1) == 'certificates' ? 'active' : '' }}"
                        href="{{ route('admin.certificates.index') }}">
                        <i class="nav-icon icon-badge"></i> <span class="title">
                            @lang('menus.backend.sidebar.certificates.title')</span>
                    </a>
                </li>
            @endif

            @if ($logged_in_user->hasRole('instructor'))
                <li class="nav-item ">
                    ...
                    <ul class="nav-dropdown-items">
                        <li class="nav-item">
                            <a class="nav-link {{ active_class(Active::checkUriPattern('admin/settings')) }}"
                                href="{{ route('admin.general-settings1') }}">
