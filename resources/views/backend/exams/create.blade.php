...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="page-title float-left mb-0">@lang('labels.backend.exams.create')</h3>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-12 col-lg-6 form-group">
                    ...
                    {!! Form::select('supervisors[]', $supervisors, old('supervisors'), ['class' => 'form-control select2 js-example-placeholder-multiple', 'multiple' => 'multiple', 'required' => false]) !!}
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4  form-group">
                    ...
                    {!! Form::number('exam_status', old('exam_status'), ['class' => 'form-control', 'placeholder' => trans('labels.backend.exams.fields.exam_status')]) !!}
            ...
            <div class="row">
                <div class="col-12 col-lg-4 form-group">
                    ...
                    {!! Form::label('status', trans('labels.backend.exams.fields.published'), ['class' => 'control-label font-weight-bold']) !!}
