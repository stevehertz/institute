...
@if ($logged_in_user->hasRole('teacher'))
    @php
        $teacherProfile = $logged_in_user->teacherProfile ? $logged_in_user->teacherProfile : '';
    ...
    <div class="row">
        <div class="col-6">
            <div class="form-group">
                ...
                {{ html()->text('facebook_link')->class('form-control')->value(isset($teacherProfile->facebook_link) ? $teacherProfile->facebook_link : '')->placeholder(__('labels.teacher.facebook_link')) }}
            </div><!--form-group-->
        </div><!--col-->
        <div class="col-6">
            <div class="form-group">
                ...
                {{ html()->text('twitter_link')->class('form-control')->value(isset($teacherProfile->twitter_link) ? $teacherProfile->twitter_link : '')->placeholder(__('labels.teacher.twitter_link')) }}
            </div><!--form-group-->
        </div><!--col-->
    </div><!--row-->
    ...
    <div class="row">
        <div class="col">
            <div class="form-group">
                ...
                {{ html()->text('linkedin_link')->class('form-control')->value(isset($teacherProfile->linkedin_link) ? $teacherProfile->linkedin_link : '')->placeholder(__('labels.teacher.linkedin_link')) }}
            </div><!--form-group-->
        </div><!--col-->
    </div><!--row-->
    ...
    <div class="row">
        <div class="col">
            <div class="form-group">
                ...
                {{ html()->textarea('description')->class('form-control')->value(isset($teacherProfile->description) ? $teacherProfile->description : '')->placeholder(__('labels.teacher.description')) }}
            </div><!--form-group-->
        </div><!--col-->
    </div><!--row-->
@endif
