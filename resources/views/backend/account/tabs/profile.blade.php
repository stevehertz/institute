    ...
    <table class="table table-striped table-hover table-bordered">
        ...
        @if (config('registration_fields') != null)
            ...
            @foreach ($fields as $item)
                <tr>
                    <th>{{ __('labels.backend.general_settings.user_registration_settings.fields.' . $item->name) }}
                    </th>
