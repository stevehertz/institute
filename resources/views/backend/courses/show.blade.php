                ...
                <div class="col-12">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td>{{ ($course->free == 1) ? trans('labels.backend.courses.fields.free') :
                            $course->price.' '.$appCurrency['symbol'] }}<br>
                                {{ $course->USD_cost}} USD <br>
                                {{ $course->AUD_cost}} AUD <br>
                                {{ $course->EUR_cost}} EUR <br>
                                {{ $course->GBP_cost}} GBP
