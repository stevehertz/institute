                            ...
                            <tbody>
                                @foreach ($slides_list as $key => $item)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{ html()->label(html()->checkbox('')->id($item->id)->checked($item->status == 1 ? true : false)->class('switch-input')->attribute('data-id', $item->id)->value($item->status == 1 ? 1 : 0) . '<span class="switch-label"></span><span class="switch-handle"></span>')->class('switch switch-lg switch-3d switch-primary') }}
                                        </td>
                                        <td>
                                            ...
                                            <form id="delete-form" action="{{ route('admin.sliders.destroy', ['slider' => $item->id]) }}"
        ...
        <div class="card-body">
            @if (count($slides_list) > 0)
                <div class="row justify-content-center">
                    <div class="col-6  ">
                        <h4 class="">
                            @lang('labels.backend.hero_slider.sequence_note')
                        </h4>
                        ...
                        <a href="{{ route('admin.courses.index') }}" class="btn btn-default border float-left">
                            @lang('strings.backend.general.app_back_to_list')
                        </a>

                        <a href="#" id="save_timeline" class="btn btn-primary float-right">
