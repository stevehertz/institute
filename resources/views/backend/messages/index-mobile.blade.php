                ...
                <div class="inbox_msg">
                    ...
                    <form method="post" class="d-none compose-message" action="{{route('admin.messages.send')}}">
                        ...
                        <div class="headind_srch bg-dark">
                            <div class="chat_people header row">
                                <div class="col-12 col-lg-3">
                                    <p class="font-weight-bold text-white mb-0" style="line-height: 35px">{{trans('labels.backend.messages.subject')}}:</p>
                                </div>

                                <div class="col-lg-9 col-12 text-dark">
                                    {!! Form::text('subject',  (request('subject') ? request('subject') : old('subject')), ['class' => 'form-control']) !!}
                                </div>
                            </div>
                        </div>
                        <div class="mesgs">
