                                                        ...
                                                        <div class="course-list-text">
                                                            ...
                                                            <div class="course-meta">
                                                                <span class="course-category bold-font"><a
                                                                        ...
                                                                        @else
                                                                            <span>  {{Session::get('cartCurrency')?Session::get('cartCurrency') : $cartCurrency['short_code'].' '}}.{{$course->price}}</span>
                                                                        @endif</a></span>
                            ...
                            @else
                                <div class="order-payment">
                                    ...
                                    <div id="accordion">
                                        ...
                                        {{--                                            Mpesa option here--}}
                                        @if(!$cartCurrency ==null && $cartCurrency =='KES')
                                            @if(config('mpesa.active') == 1)
                                            <div class="payment-method w-100 mb-0">
                                                <div class="payment-method-header">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="method-header-text">
                                                                <div class="radio">
                                                                    <label>
                                                                        <input data-toggle="collapse"
                                                                               href="#collapsePaymentMpesa"
                                                                               type="radio" name="paymentMethod"
                                                                               value="2">
                                                                        Pay with Mobile Money using <img
                                                                                    src="{{asset('assets/img/banner/mpesa-payments.png')}}"
                                                                                    width="100px"
                                                                                    alt="">
                                                                    </label>
                                                                </div>
                                                ...
                                                <div class="check-out-form collapse disabled" id="collapsePaymentMpesa"
                                                     data-parent="#accordion">
                                                    <div class="row">
                                                    <div class="col-md 4">
                                                        <form class="w3-container w3-display-middle w3-card-4 "
                                                                                  method="POST" action="{{route('mpesaexpresspayment')}}">
                                                            {{ csrf_field() }}
                                                            <p> @lang('labels.frontend.cart.pay_securely_mpesa')</p>
                                                            <div class="form-control">
                                                                <p>Amount:
                                                                <input class="form-control col-md-4" name="amount" required
                                                                       value=" {{Session::get('cartCurrency')?Session::get('cartCurrency') : $cartCurrency['short_code'].' '}}.{{number_format(Cart::session(auth()->user()->id)->getTotal(),0)}}"
                                                                       readonly>
                                                                </p>
                                                                <input type="hidden" name="uniqueOrderId" value="{{getOrderNumber()}}">
                                                                <input type="hidden" name="amount" value="{{Cart::session(auth()->user()->id)->getTotal(),0}}">
                                                                <p>Enter phone number: <input class="form-control" type="number" name="clientPhone" value="254712345678" placeholder="Enter in format: 254712345678"></p>
                                                            </div>

                                                            <button type="submit"
                                                                    class="text-white genius-btn mt25 gradient-bg text-center text-uppercase  bold-font">
                                                                @lang('labels.frontend.cart.pay_with_mpesa_express') <i
                                                                        class="fas fa-caret-right"></i>
                                                            </button>
                                                        </form>
                                                    </div>
                                                    <div class="col-md 4">
                                                        How to Pay: <br>
                                                        Got to MPESA menu <br>
                                                        Select Lipa Na Mpesa <br>
                                                        Select Pay bill <br>
                                                        Enter Business Number:<span class="bold-font"> {{config('mpesa.paybill')}} </span><br>
                                                        Enter Account Number: <span class="bold-font"> {{getOrderNumber()}}</span><br>
                                                        Enter Amount: <span class="bold-font">{{number_format(Cart::session(auth()->user()->id)->getTotal(),0)}} </span>

                                                        <form class="w3-container w3-display-middle w3-card-4 "
                                                                                method="POST" action="{{route('makeMpesaOrder')}}">
                                                            {{ csrf_field() }}
                                                            <input type="hidden" name="uniqueOrderId" value="{{getOrderNumber()}}">
                                                            <button type="submit"
                                                                    class="text-white genius-btn mt25 gradient-bg text-center text-uppercase  bold-font">
                                                                @lang('labels.frontend.cart.already_paid_complete') <i
                                                                        class="fas fa-caret-right"></i>
                                                            </button>
                                                        </form>
                                                    </div>
                                        ...
                                        @if(config('pesapal.active') == 1)
                                            <div class="payment-method w-100 mb-0">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="method-header-text">
                                                                <div class="radio">
                                                                    <label>
                                                                        <input data-toggle="collapse"
                                                                               href="#collapsePaymentPesapal"
                                                                               type="radio" name="paymentMethod"
                                                                               value="2">
                                                                    </label>
                                                                    <label>Pay with <span style="color: orangered"> PESAPAL </span>
                                                ...
                                                <div class="check-out-form collapse disabled"
                                                     id="collapsePaymentPesapal"
                                                     data-parent="#accordion">
                                                    <form class="w3-container w3-display-middle w3-card-4 "
                                                          method="POST" action="{{route('make.payment')}}">
                                                        {{ csrf_field() }}
                            ...
                            <div class="sub-total-item">
                                ...
                                @else
                                    <div class="purchase-list mt15 ul-li-block">
                                        ...
                                        <div class="in-total text-uppercase">@lang('labels.frontend.cart.total') <span> {{Session::get('cartCurrency')?Session::get('cartCurrency') : $cartCurrency['short_code']}}
                                                0.00</span></div>
                                    </div>
