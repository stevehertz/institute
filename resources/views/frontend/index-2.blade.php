            ...
            <section id="partner" class="partner-section">
                <div class="container">
                    <div class="section-title-2 mb65 headline text-left ">
                        <h3>Our <span>@lang('labels.frontend.layouts.partials.partners')</span></h3>
                    </div>
    ...
    @if ($sections->clients->status == 1)
        @if (count($clients) > 0)
            ...
            <section id="client" class="client-section">
                <div class="container">
                    <div class="section-title-2 mb65 headline text-left ">
                        <h3>Our <span>@lang('labels.frontend.layouts.partials.clients')</span></h3>
                    </div>

                    <div class="client-item sponsor-1 text-center">
