                    ...
                    @if(($footer_data->social_links->status == 1) && (count($footer_data->social_links->links) > 0))
                        <div class="col-md-4">
                            <div class="footer-social ul-li ">
                                <h3 class="widget-title">@lang('labels.frontend.layouts.partials.social_network')</h3>
                                <ul>
                    ...
                    @if($footer_data->newsletter_form->status == 1)
                        <div class="col-md-8">
                            <div class="subscribe-form ml-0 ">
                                <h3 class="widget-title">@lang('labels.frontend.layouts.partials.subscribe_newsletter')</h3>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="copy-right-text">
                            <p>Powered By <a href="#" target="_blank" class="mr-4"></a>  {!!  $footer_data->copyright_text->text !!}</p>
                        </div>
                    </div>
                    @endif
