                ...
                <div class="navbar-default d-inline-block w-100">
                    <div class="navbar-header float-left">
                        <a class="navbar-brand text-uppercase" href="{{ url('/') }}">
                            <img src="{{ asset('storage/logos/' . config('logo_white_image')) }}" alt="logo">
                        </a>
                    </div><!-- /.navbar-header -->
            ...
            <div id="menu-container">
                ...
                <div class="menu-wrapper">
                    <div class="row">
                        ...
                        <div class="logo-area">
                            <a href="{{ url('/') }}">
                                <img src="{{ asset('storage/logos/' . config('logo_w_image')) }}"
                                    alt="Logo_not_found">
                            </a>
                        </div>
                                ...
                                @else
                                    <li class="card">
                                        ...
                                        <ul id="collapse{{ $menu->id }}" class="submenu collapse "
                                            aria-labelledby="heading{{ $menu->id }}" data-parent="#accordion"
                                            style="">
                                            @foreach ($menu->subs as $item)
                    ...
                    @if (count($locales) > 1)
                        ...
                        <li class="card">
                            <div class="card-header" id="headingLang">
                                <button class="menu-link" data-toggle="collapse" data-target="#collapseLang"
                                    aria-expanded="true" aria-controls="collapseLang">
                                    @lang('menus.language-picker.language')
                                    ({{ strtoupper(app()->getLocale()) }})
                                </button>
                            </div>
                            <ul id="collapseLang" class="submenu collapse " aria-labelledby="headingLang"
