    ...
    <div class="side-menu">
        <div class="bor17 of-hidden pos-relative">
            <form action="{{ route('blogs.search') }}" method="get">
                <input class="stext-103 cl2 plh4 size-116 p-l-28 p-r-55" type="text" name="q"
                        ...
                        {{-- @if ($global_featured_course->course_image != '')
                            <a href="#" class="wrao-pic-w size-214 hov-ovelay1 m-r-20">
                                <img src="{{ asset('storage/uploads/' . $global_featured_course->course_image) }}"
                                    alt="{{ $global_featured_course->title }}">
                            </a>
                        @endif --}}

                        <div class="size-215 flex-col-t p-t-8">
                            <a href="{{ route('courses.show', [$global_featured_course->slug]) }}" class="stext-116 cl8 hov-cl1 trans-04">
