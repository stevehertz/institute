...
return array(
  ...
  array(
    ...
    array(
      ...
      array(
        ...
        'price' => 'Price',
        'KES_cost' => 'Price in KES',
        'USD_cost' => 'Price in USD',
        'AUD_cost' => 'Price in AUD',
        'EUR_cost' => 'Price in EUR',
        'GBP_cost' => 'Price in GBP',
        'CAD_cost' => 'Price in CAD',
        'strike' => 'Strike Price',
    ...
    array(
      ...
      array(
        ...
        'invigilators' => 'Select Invigilators',
        'max_allocated_time' => 'Maximum allocated time',
        ...
        'exam_status' => 'Exam status(scheduled, ongoing, completed, cancelled, postponed, paused)',
        'scheduled_end_time' => 'Scheduled end-time',
        'scheduled_start_time' => 'Scheduled start time',
        'students_enrolled' => 'Students registered',
      ),
      'create' => 'Create Exam',
      'edit' => 'Edit Exam',
      'view' => 'View Exams',
    ...
    'lessons' =>
    array(
      'slu  g_placeholder' => 'Input slug or it will be generated automatically',
      'fields' =>
      array(
        'course' => 'Course',
        'title' => 'Title',
    ...
    array(
      ...
      array(
        ...
        'pesapal' => 'Pesapal Payment Method',
        'mpesa' => 'Mpesa Payment Method',
        'paypal_note' => 'Redirects to paypal for payment',
        'pesapal_note' => 'Opens pesapal page for payment. Merchant details are set in .env file',
        'mpesa_note' => 'For accepting mobile payments. merchant details are set in .env file',
        ...
        'how_to_pesapal' => 'How to get Pesapal API Credentials?',
        'how_to_mpesa' => 'How to get Mpesa API Credentials?',
        ...
        'lipa_na_mpesa_passkey' => 'Pass key',
  ...
  array(
    ...
    array(
      ...
      'order_payment' => 'Order <span>Payment Options.</span>',
      ...
      'pesapal' => 'Pay with Pesapal',
      'mpesa' => 'Mpesa Payment Option',
      'pay_securely_pesapal' => 'Pay securely via Pesapal',
      'pay_securely_mpesa' => 'Pay securely via MPESA',
      'already_paid_with_mpesa' => 'Already paid, click here ',
      'already_paid_complete' => 'Already paid? Click here to complete',
      'pay_with_mpesa_express' => 'Pay with Mpesa Express',
    ),
    'contact' =>
    array(
      'title' => 'Contact',
    ...
    array(
      ...
      'buy_now' => 'Buy Now',
      'get_now' => 'Get Now',
      'course_pending_purchase' => 'This items is has been added on pending order. Kindly wait for processing.',
      'go_to_dashboard' => 'View pending orders',
      'explore_more_courses' => 'Explore more courses here',
      'already_certified' => 'You have already been certified in this course.',
  ...
  'teacher' =>
  array(
    'teacher_register' => 'Register as Instructor? Click Here',
    'teacher_register_box_title' => 'Instructor Register',
