...
Route::group(['prefix' => '/webhooks'], function () {
    //PESAPAL
    Route::get('donepayment', [PaymentController::class, 'paymentSuccess'])->name('paymentsuccess');
    Route::get('paymentconfirmation', [PaymentController::class, 'confirm']);
});

Route::get('checkStatus', [PaymentController::class, 'confirm', 'as' => 'checkStatus'])->name('checkStatus1');
Route::post('pesapal-ipn', [PaymentController::class, 'confirm']);
